...
extern "C"
{
	...
	*	0				|	其他错误
	*	@note 
	*		前置条件：InitComm/InitCommExt/ConnectIDRDev 调用成功
	*/
	...
	*/
	...
	/**
	*	@brief	生成竖版身份证正反两面图片(输出目录：dll所在目录的cardv.jpg和SetCardJPGPathNameV指定路径)
	*	@param	:
	*		无
	*	@return
	*	返回值说明如下：
	...
	*	0				|	失败
	*	@note 
	*	前置条件：GetBmpPhoto/GetBmpPhotoExt 调用成功
	*/
	...
	/**
	*	@brief	生成横版身份证正反两面图片(输出目录：dll所在目录的cardh.jpg和SetCardJPGPathNameH指定路径)
	*	@param	:
	*		无
	*	@return
	*	返回值说明如下：
	...
	*/
	...
	/**
	*	@brief	生成身份证正面图片(输出目录：dll所在目录的cardf.jpg指定路径)
	*	@param	:
	*		无
	*	@return
	*	返回值说明如下：
	...
	*/
	...
	/**
	*	@brief	生成身份证反面图片(输出目录：dll所在目录的cardb.jpg指定路径)
	*	@param	:
	*		无
	*	@return
	*	返回值说明如下：
	...
	*/
	...
	/*
	*	@brief	设置竖版身份证正反两面图片全路径
	*	@param	:
	*	参数说明如下表
	*	name			|	type		|	param direction		|	description of param
	*	----------------|---------------|-----------------------|------------------------
	*	path			|	char*		|	[in]				|	生成图片jpg文件全路径
	*	@return
	*		无
	*	@note 
	*		未设置为本dll所在目录的cardv.jpg
	*/
	ZKINTERFACE void ZKAPI SetCardJPGPathNameV(char *path);

	/**
	*	@brief	获取竖版身份证正反两面图片全路径
	*	@param	:
	*	参数说明如下表
	*	name			|	type		|	param direction		|	description of param
	*	----------------|---------------|-----------------------|------------------------
	...
	*/
	...
	/**
	*	@brief	获取竖版身份证正反两面JPG图像base64编码字符串
	*	@param	:
	*	参数说明如下表
	*	name			|	type		|	param direction		|	description of param
	*	----------------|---------------|-----------------------|------------------------
	...
	*		无
	*	@note 
	*		前提：ExportCardImageB 调用成功	
	*/
	ZKINTERFACE void ZKAPI getJPGCardBase64B(char *data, int cbData);


	/**
	*	@brief	设置身份证头像背景色透明阀值
	*	@param	:
	*	参数说明如下表
	*	name			|	type		|	param direction		|	description of param
	*	----------------|---------------|-----------------------|------------------------
	*	R				| unsigned char |	[in]				|	0~255,默认235
	*	G				| unsigned char |	[in]				|	0~255,默认235
	*	B				| unsigned char |	[in]				|	0~255,默认235
	*	@return
	*		无
	*	@note 
	*		RGB三个值全部大于设置参数，则自动设置为透明色	
	*/
